...
const UsersRoles = () => {
  ...
  const getStatusBadge = (status) => {
     ...
     const styles = {
      ...
      disabled: { backgroundColor: '#dc3545', color: 'white' }
   ...
   const icons = {
      ...
      active: <Icon icon="heroicons:check" style={{ fontSize: '0.65rem', marginRight: '0.2rem' }} />,

      pending: <Icon icon="heroicons:pause" style={{ fontSize: '0.65rem', marginRight: '0.2rem' }} />,

      disabled: <Icon icon="heroicons:lock-closed" style={{ fontSize: '0.65rem', marginRight: '0.2rem' }} />
        ...
        <div className="row">
          ...
          <div className="col-12">
            ...
            <div className="mb-4">
              ...
              <h5 className=" fw-bold text-dark mb-2 d-flex align-items-center gap-2 mt-3">

                <Icon icon="heroicons:users" className="fw-semibold" />
                            ...
                            <div className="d-flex align-items-center gap-3">
                              ...
                              {user.status === 'pending' ? (
                                ...
                                <button
                                  ...
                                  className="btn  text-primary p-0 d-flex align-items-center gap-1"
                              ...
                              <button
                                ...
                                className="btn  text-danger p-0 d-flex align-items-center gap-1  "

                              >

                                <Icon icon="heroicons:trash" />

                                <span className="smal l">Remove</span>
                  ...
                  <div className="modal-content shadow-lg border-0">
                      ...
                      <div className="row g-4">
                        ...
                        <div className="col-12">
                          ...
                          <label className="form-label fw-semibold text-dark fs-5">
                            ...
                            <Icon icon="heroicons:user" className="me-2 fs-4"/>
                        ...
                        <div className="col-12">
                          ...
                          <label className="form-label fw-semibold text-dark fs-5">
                            ...
                            <Icon icon="heroicons:envelope" className="me-2 fs-4" />
                        ...
                        <div className="col-12">
                          ...
                          <label className="form-label fw-semibold text-dark fs-5">
                            ...
                            <Icon icon="heroicons:user-group" className="me-2 fs-4 " />
                          ...
                          <div className="mt-3 p-4 bg-primary bg-opacity-10 border border-primary border-opacity-20 rounded">
                            ...
                            <div className="d-flex align-items-center mb-2">
                              ...
                              <Icon icon="heroicons:information-circle" className="text-primary me-2 fs-4"/>
                        ...
                        <div className="col-12">
                          ...
                          <label className="form-label fw-semibold text-dark fs-5">
                            ...
                            <Icon icon="heroicons:shield-check" className="me-2 text-primary fs-4" />
                                  ...
                                  <div className="d-flex align-items-start gap-3 p-3 bg-white rounded border">
                                    ...
                                    <div className="flex-fill">
                                      ...
                                      <div className="d-flex align-items-center gap-2 mb-1">
                                        ...
                                        <Icon icon={perm.icon} className="text-primary fs-4"/>
                    ...
                    <div className="modal-footer bg-light border-0 d-flex justify-content-between align-items-center px-4 py-3">
                      ...
                      <div className="small text-muted">
                        ...
                        <Icon icon="heroicons:information-circle" className="me-1 fs-5"/>
